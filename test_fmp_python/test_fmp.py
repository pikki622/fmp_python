...
class TestFMP(unittest.TestCase):
    ...
    def get_file_from_name(name):
        ...
        return os.path.join(script_directory, 'test_data', name)
    ...
    def test_short_quote(self, mock_request):
        ...
        with open(file_path) as f:
            mock_request.get(f"{BASE_URL}/quote-short/AAPL?apikey=demo", text=f.read())
    ...
    def test_get_quote(self, mock_request):
        ...
        with open(file_path) as f:
            mock_request.get(
                f"{BASE_URL}/quote/JMCRX,JSMTX,JUESX?apikey=demo", text=f.read()
            )
    ...
    def test_get_quote_index(self, mock_request):
        ...
        with open(file_path) as f:
            mock_request.get(f"{BASE_URL}/quote/%5EGSPC?apikey=demo", text=f.read())
    ...
    def test_get_historical_chart(self, mock_request):
        ...
        with open(file_path) as f:
            mock_request.get(
                f"{BASE_URL}/historical-chart/1min/JMCRX?apikey=demo",
                text=f.read(),
            )
    ...
    def test_get_historical_chart_index(self, mock_request):
        ...
        with open(file_path) as f:
            mock_request.get(
                f"{BASE_URL}/historical-chart/4hour/%5EGSPC?apikey=demo",
                text=f.read(),
            )
    ...
    def test_get_historical_price(self, mock_request):
        ...
        with open(file_path) as f:
            mock_request.get(
                f"{BASE_URL}/historical-price-full/JMCRX?apikey=demo",
                text=f.read(),
            )
