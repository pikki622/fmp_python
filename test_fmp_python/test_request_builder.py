...
class TestRequestBuilder(unittest.TestCase):
    ...
    def test_compile_resquest_category(self):
        ...
        self.assertEqual(rb.compile_request(), f"{BASE_URL}/quote?apikey=demo") 
    ...
    def test_compile_request_subcategory(self):
        ...
        self.assertEqual(
            rb.compile_request(), f"{BASE_URL}/quote/^DJI,^GSPC?apikey=demo"
        )
    ...
    def test_compile_request_subcategories(self):
        ...
        self.assertEqual(
            rb.compile_request(),
            f"{BASE_URL}/historical-chart/1hour/^GSPC?apikey=demo",
        )
    ...
    def test_compile_resquest_param(self):
        ...
        self.assertEqual(
            rb.compile_request(),
            f"{BASE_URL}/balance-sheet-statement/AAPL?period=quarter&apikey=demo",
        )
